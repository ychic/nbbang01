...
<div class="container">
	...
	<div class="table-responsive">
		<table class="table table-hover">
		  ...
		  <tbody>
		    <tr>
		      <td class="text-center">Recommend No</td>
		      <td><a href="<c:url value='/recommandView.do'/>" style="text-decoration:none; color:black">Recommend Title</a></td>
		      <td class="text-center">Recommend Writer</td>
		      <td class="text-center">Recommend PostDate</td>
		      <td class="text-center">Recommend ViewCount</td>
		    </tr>
		    <tr>
		      <td class="text-center">Recommend No</td>
		      <td><a href="<c:url value='/recommandView.do'/>" style="text-decoration:none; color:black">Recommend Title</a></td>
