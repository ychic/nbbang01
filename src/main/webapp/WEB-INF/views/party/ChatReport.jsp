...
<div class="container">
   ...
   <div>
   <form id="myform" class="form-horizontal" method="post" action="<c:url value='/chatReportOk.do'/>">
   		<div class="form-group">
            <label class="col-sm-2 control-label">신고채팅 NO</label>
            <div class="col-sm-4">
               <input type="text" class="form-control" name="chatno" value="${record.chatno}" readonly>
            </div>
            <label class="col-sm-2 control-label">신고 대상자 ID</label>
            <div class="col-sm-4">
               <input type="text" class="form-control" name="reportId" value="${email ne record.bbswriter ? record.bbswriter : record.participant}" readonly>
            </div>            
    	</div>   
      	<hr class="col-md-12" style="width:900px;margin-left:50px;"/>
         <div class="form-group">
         ...
         <div class="btns1">
               ...
               <button class="btn btn-secondary" onclick="location.href='partyChat.do'">취소</button>
         </div>
      </form>
   </div>
</div>
