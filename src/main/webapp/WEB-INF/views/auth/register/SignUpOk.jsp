...
<body>
	<div class="wrapper fadeInDown">
	  <div id="formContent">
	    ...
	    <!-- Icon -->
	    <div class="jumbotron">
		  <h1 class="linear-wipe" style="font-size: 50px;">Welcome to Nbbang</h1>
		  	<form action="<c:url value='/joinAfter.do' />">
			<img src="/nbbang/resources/images/firstpage/first06.jpg" width="100%" height="100%">
	      	<input type="submit" class="fadeIn fourth" value="로그인 후 이용하기" style="margin-top: 100px;">
		  	</form>
		</div>
