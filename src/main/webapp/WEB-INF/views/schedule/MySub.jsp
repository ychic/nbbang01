...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-11">
			...
			<h4><span class="label label-info" style="text-align: left; margin: 0px;">All</span>  Total  ${allCost.allCost}원 입니다
			</h4>
			</c:if>
			<c:if test="${empty allCost.allCost}">
			<h4><span class="label label-info" style="text-align: left; margin: 0px;">All</span>  Total  0원 입니다
			</h4>
			</c:if>
