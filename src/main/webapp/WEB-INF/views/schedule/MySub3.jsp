		...
		<div class="col-sm-11">
			...
			<div class="col-sm-12">
					...
					<c:if test="${not empty secondRecord}">
						<c:forEach items="${secondRecord}" var="mysub3">
						
							<div class="col-md-3" style="padding-left: 0px;">
							
								<c:if test="${mysub3.subservice eq '멜론'}">
								  ...
								  <ul class="list-group list-group-flush" style="border-top: hidden;">
								    <li class="list-group-item">${mysub3.subservice}
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            ...
									            <input type="text" class="form-control" id="subName2" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            ...
									            <input type="text" class="form-control" id="datepicker2" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay2" name="money" value="${mysub3.money}">
									          </div>
									          ...
									          <!-- 기존 데이터 넘기기(쿼리문때문에) -->
									          <input type="hidden" name="orisubname" value="${mysub3.subservice}" />
									          <input type="hidden" name="oripayday" value="${mysub3.paymentday}" />
									          <input type="hidden" name="orimoney" value="${mysub3.money}" />
									          <input type="hidden" name="orisfno" value="${mysub3.sfno}" />
									          <input type="hidden" name="subno" value="${mysub3.subno}" />
									          
									          
									          <div class="modal-footer">
										        <button type="button" class="btn btn-default" data-dismiss="modal">취소</button>
										        <button type="submit" class="btn btn-primary">수정</button>
										        <a href="<c:url value='/mysub/delete.do?subno=${mysub3.subno}'/>"
								    ...
								    <li class="list-group-item">${mysub3.paymentday}</li>
								    <li class="list-group-item">${mysub3.money}원</li>
								  </ul>
								</c:if>
								
								<c:if test="${mysub3.subservice eq '넷플릭스'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName3" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker3" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay3" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '웨이브'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName4" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker4" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay4" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '디즈니+'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName5" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker5" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay5" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '월간과자'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName6" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker6" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay6" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '닌텐도스위치'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName7" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker7" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay7" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '벅스'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName8" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker8" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay8" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '스포티비나우'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName9" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker9" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay9" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '아이클라우드'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName10" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker10" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay10" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '유튜브프리미엄'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName11" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker11" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay11" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '애플뮤직'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName12" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker12" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay12" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '카카오이모티콘+'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName13" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker13" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay13" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '꾸까'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName14" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker14" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay14" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '네이버+'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName15" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker15" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay15" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '더반찬'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName16" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker16" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay16" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '런드리고'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName17" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker17" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay17" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq 'BBC사이언스'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName18" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker18" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay18" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '리디셀렉트'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName19" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker19" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay19" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '밀리의 서재'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName20" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker20" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay20" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '매경e신문'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName21" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker21" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay21" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '빅이슈'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName22" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker22" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay22" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '예스24북클럽'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName23" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker23" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay23" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '왓챠'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName24" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker24" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay24" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '티빙'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName25" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker25" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay25" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '플로'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName26" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker26" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay26" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '플레이스테이션'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName27" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker27" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay27" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '쏘카'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName28" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker28" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay28" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '와이즐리'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName29" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker29" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay29" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '위클리 셔츠'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName30" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker30" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay30" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '잡플래닛'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName31" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker31" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay31" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '쿠팡 와우'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName32" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker32" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay32" name="money" value="${mysub3.money}">
									          </div>
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName33" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker33" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay33" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '하비인더박스'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName34" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker34" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay34" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '해피문데이'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName35" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker35" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay35" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '윌라'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName36" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker36" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay36" name="money" value="${mysub3.money}">
									          </div>
								...
								<!-- 여기까지 -->
								<c:if test="${mysub3.subservice eq '조인스 프라임'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName37" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker37" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay37" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '퍼블리'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName38" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker38" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay38" name="money" value="${mysub3.money}">
									          </div>
								...
								<c:if test="${mysub3.subservice eq '핀즐'}">
								  <div class="thumbnail" style="margin-bottom: 0px; border-bottom: hidden;"> <!-- dotted -->
									    ...
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form action="<c:url value='/mysub/edit.do'/>" method="post">
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">구독서비스명</label>
									            <input type="text" class="form-control" id="subName39" name="subservice" value="${mysub3.subservice}" style="width:450px;display: inline-block;">
									            <!-- 구독 리스트 클릭 버튼 -->
									          ...
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">결제일</label>
									            <input type="text" class="form-control" id="datepicker39" name="paymentday">기존 결제일: ${mysub3.paymentday}
									          </div>
									          <div class="form-group">
									            <label for="recipient-name" class="control-label">월 구독료</label>
									            <input type="text" class="form-control" id="subPay39" name="money" value="${mysub3.money}">
									          </div>
