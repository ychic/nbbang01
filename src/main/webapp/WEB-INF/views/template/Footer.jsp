        			...
        			<div class="colInfo">
	        			...
	        			<ul class="listArticles">
	        				<li layout="row" class="verticalCenter">
	        					<a class="articleThumb fsr" href="#"><img src="<%=request.getContextPath()%>/resources/images/our-blog/img-4.jpg" alt=""></a>
	        					<div class="info">
	        				...
	        				<li layout="row" class="verticalCenter">
	        					<a class="articleThumb fsr" href="#"><img src="<%=request.getContextPath()%>/resources/images/our-blog/img-5.jpg" alt=""></a>
	        					<div class="info">
	        						<h3 class="articleTitle"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing</a></h3>
	        						<div class="date">Jan 9, 2016</div>
	        					</div>
	        				...
	        				<li layout="row" class="verticalCenter">
	        					<a class="articleThumb fsr" href="#"><img src="<%=request.getContextPath()%>/resources/images/our-blog/img-6.jpg" alt=""></a>
	        					<div class="info">
	        						<h3 class="articleTitle"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing</a></h3>
	        						<div class="date">Jan 9, 2016</div>
	        					</div>
        		...
        		<div class="col-md-4 col-sm-6">
        			<div class="colInfo">
	        			...
	        			<div class="instagramImages clearfix">
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-1.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-2.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-3.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-4.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-5.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-6.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-7.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-8.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-9.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-3.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-4.jpg" alt=""></a>
	        				<a href="#"><img src="<%=request.getContextPath()%>/resources/images/instagram/img-5.jpg" alt=""></a>
	        			</div>
