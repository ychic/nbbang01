...
public class PagingUtil {
	...
	public static String recommandBbsPaging(int totalRecordCount, int pageSize, int blockPage, int nowPage,
			String page) {
		...
		if (intTemp != 1) {
			pagingStr += "<li>\r\n" + "<a href='" + page + "nowPage=1'>\r\n"
					+ "<span aria-hidden=\"true\">&laquo;</span>\r\n" + "</a>\r\n" + "</li>\r\n" + "<li >\r\n"
					+ "<a href='" + page + "nowPage=" + (intTemp - blockPage) + "&ussrcategoryname=recommand' >\r\n"
					+ "<span aria-hidden=\"true\">&lsaquo;</span>\r\n" + "</a>\r\n" + "</li>";
		...
		while (blockCount <= blockPage && intTemp <= totalPage) { // 페이지 오버 를 체크
			...
			if (intTemp == nowPage) {
				...
				pagingStr += "<li><a href='" + page + "nowPage=" + intTemp + "&ussrcategoryname=recommand'>" + intTemp + "</a></li>";
		...
		if (intTemp <= totalPage) {
			pagingStr += "<li>\r\n" + "<a href='" + page + "nowPage=" + intTemp + "'>\r\n"
					+ "<span aria-hidden=\"true\">&rsaquo;</span>\r\n" + "</a>\r\n" + "</li>\r\n" + "<li>\r\n"
					+ "<a href='" + page + "nowPage=" + totalPage + "&ussrcategoryname=recommand' >\r\n"
					+ "<span aria-hidden=\"true\">&raquo;</span>\r\n" + "</a>\r\n" + "</li>";
	...
	public static String freeBbsPaging(int totalRecordCount, int pageSize, int blockPage, int nowPage,
			String page) {
		...
		if (intTemp != 1) {
			pagingStr += "<li>\r\n" + "<a href='" + page + "nowPage=1'>\r\n"
					+ "<span aria-hidden=\"true\">&laquo;</span>\r\n" + "</a>\r\n" + "</li>\r\n" + "<li >\r\n"
					+ "<a href='" + page + "nowPage=" + (intTemp - blockPage) + "&ussrcategoryname=free' >\r\n"
					+ "<span aria-hidden=\"true\">&lsaquo;</span>\r\n" + "</a>\r\n" + "</li>";
		...
		while (blockCount <= blockPage && intTemp <= totalPage) { // 페이지 오버 를 체크
			...
			if (intTemp == nowPage) {
				...
				pagingStr += "<li><a href='" + page + "nowPage=" + intTemp + "&ussrcategoryname=free'>" + intTemp + "</a></li>";
		...
		if (intTemp <= totalPage) {
			pagingStr += "<li>\r\n" + "<a href='" + page + "nowPage=" + intTemp + "'>\r\n"
					+ "<span aria-hidden=\"true\">&rsaquo;</span>\r\n" + "</a>\r\n" + "</li>\r\n" + "<li>\r\n"
					+ "<a href='" + page + "nowPage=" + totalPage + "&ussrcategoryname=free' >\r\n"
					+ "<span aria-hidden=\"true\">&raquo;</span>\r\n" + "</a>\r\n" + "</li>";
